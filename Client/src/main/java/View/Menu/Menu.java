...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        menuList.addItem(new MenuModel("Dashboard", MenuModel.MenuType.MENU));
        ...
        menuList.addItem(new MenuModel("Shutdown / Restart", MenuModel.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        menuList = new View.Menu.MenuList<>();
    ...
    private View.Menu.MenuList<String> menuList;
